...
public struct SetLiveInfoResult(bool success, string message, BliveTitleResponse data)
{
    public bool Success { get; set; } = success;
    public string Message { get; set; } = message;
    public BliveTitleResponse Data { get; set; } = data;
}
...
public class BliveArea
{
    ...
    [JsonProperty("list")]
    public List<BliveGameAreaItem> List { get; set; } = [];
}
...
public class BliveStreamResponse
{
    ...
    public List<BliveStreamLine> StreamLine { get; set; } = [];
}
...
public class BiliUIDsResponse
{
    ...
    public BiliUIDInfo[] UIDs { get; set; } = [];
}
...
public struct BliveAddAdminResult(bool success, long userId, string userName)
{
    public bool Success { get; set; } = success;
