...
public struct ObsMethodHandler(TaskCompletionSource<object> tcs, Type type)
{
    public TaskCompletionSource<object> Tcs { get; set; } = tcs;
    public Type Type { get; set; } = type;
}

public struct ObsResponseMessage(WebSocketMessageType type, string message)
{
    public WebSocketMessageType Type { get; set; } = type;
