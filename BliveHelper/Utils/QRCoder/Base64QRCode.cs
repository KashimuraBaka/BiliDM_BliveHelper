    ...
    public string GetGraphic(int pixelsPerModule, Color darkColor, Color lightColor, bool drawQuietZones = true, ImageType imgType = ImageType.Png)
    {
        if (imgType == ImageType.Png)
        {
            ...
            else
            {
                ...
                {
                    darkColorBytes = [darkColor.R, darkColor.G, darkColor.B, darkColor.A];
                    lightColorBytes = [lightColor.R, lightColor.G, lightColor.B, lightColor.A];
                }
                else
                {
                    darkColorBytes = [darkColor.R, darkColor.G, darkColor.B];
                    lightColorBytes = [lightColor.R, lightColor.G, lightColor.B];
                }
