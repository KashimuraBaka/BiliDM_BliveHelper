...
{
    private static readonly byte[] _bitmapHeaderPart1 = [0x42, 0x4D];
    private static readonly byte[] _bitmapHeaderPart2 = [0x00, 0x00, 0x00, 0x00, 0x36, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00];
    private static readonly byte[] _bitmapHeaderPartEnd = [0x01, 0x00, 0x18, 0x00];
...
public static class BitmapByteQRCodeHelper
{
        ...
        EciMode eciMode = EciMode.Default, int requestedVersion = -1)
    {
        ...
        var qrCodeData = qrGenerator.CreateQrCode(plainText, eccLevel, forceUtf8, utf8BOM, eciMode, requestedVersion);
    ...
    public static byte[] GetQRCode(string txt, QRCodeGenerator.ECCLevel eccLevel, int size)
    {
        ...
        var qrCode = qrGen.CreateQrCode(txt, eccLevel);
