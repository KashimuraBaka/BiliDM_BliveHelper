...
public static partial class PayloadGenerator
{
    ...
    public class Geolocation(string latitude, string longitude, Geolocation.GeolocationEncoding encoding = Geolocation.GeolocationEncoding.GEO) : Payload
    {
        private readonly string _latitude = latitude.Replace(",", ".");
        private readonly string _longitude = longitude.Replace(",", ".");
        private readonly GeolocationEncoding _encoding = encoding;
