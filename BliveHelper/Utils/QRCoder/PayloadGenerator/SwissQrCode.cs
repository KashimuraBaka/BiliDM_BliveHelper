    ...
    public class SwissQrCode : Payload
    {
        ...
        public class Contact
        {
            ...
            public static Contact WithStructuredAddress(string name, string zipCode, string city, string country, string street = null, string houseNumber = null)
                => new(name, zipCode, city, country, street, houseNumber, AddressType.StructuredAddress);
            ...
            public static Contact WithCombinedAddress(string name, string country, string addressLine1, string addressLine2)
                => new(name, null, null, country, addressLine1, addressLine2, AddressType.CombinedAddress);
            ...
            {
                //Pattern extracted from https://qr-validation.iso-payments.ch as explained in https://github.com/codebude/BliveHelper.Utils.QRCoder/issues/97
        ...
        public override string ToString()
        {
            ...
            SwissQrCodePayload += string.Concat(Enumerable.Repeat(_br, 7));
