...
public partial class QRCodeGenerator
{
    ...
    private static class CapacityTables
    {
        ...
        /// <exception cref="BliveHelper.Utils.QRCoder.Exceptions.DataTooLongException">
        ...
        public static int CalculateMinimumVersion(int length, EncodingMode encMode, ECCLevel eccLevel)
        {
            ...
            throw new BliveHelper.Utils.QRCoder.Exceptions.DataTooLongException(eccLevel.ToString(), encMode.ToString(), maxSizeByte);
        }
