...
public partial class QRCodeGenerator
{
    ...
    private static class GaloisField
    {
        ...
        public static int GetAlphaExpFromIntVal(int intVal)
        {
            ...
            static void ThrowIntValOutOfRangeException() => throw new ArgumentOutOfRangeException(nameof(intVal), "The provided integer value is out of range, as zero is not representable.");
        }
