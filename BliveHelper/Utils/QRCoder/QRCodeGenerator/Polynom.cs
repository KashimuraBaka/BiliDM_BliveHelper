...
public partial class QRCodeGenerator
{
    ...
    [StackTraceHidden]
        ...
        private readonly void AssertCapacity(int min)
        {
            ...
            {
                // All math by BliveHelper.Utils.QRCoder should be done with fixed polynomials, so we don't need to grow the capacity.
        ...
        [StackTraceHidden]
#endif
            static void ThrowNotSupportedException() => throw new NotSupportedException("The polynomial capacity is fixed and cannot be increased.");
        }
    ...
    private static void ReturnArray(PolynomItem[] array)
        ...
        private static PolynomItem[] RentArray(int count)
        {
            ...
            static void ThrowArgumentOutOfRangeException() => throw new ArgumentOutOfRangeException(nameof(count), "The count must be a positive number.");
        }
        ...
        /// </summary>
        public struct PolynumEnumerator(QRCodeGenerator.Polynom polynom)
        {
            private Polynom _polynom = polynom;
            private int _index = -1;

            public readonly PolynomItem Current => _polynom[_index];
